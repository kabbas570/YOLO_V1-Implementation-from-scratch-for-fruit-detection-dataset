from tensorflow.keras.layers import Conv2D, MaxPooling2D,  Flatten, Dense, Reshape, LeakyReLU,BatchNormalization
...
def model_tiny_yolov1(input_size=(448, 448, 3)):
    ...
    x = Flatten()(x)
    x = Dense(3577, activation='linear', name='connected_0')(x)
    outputs = Reshape((7, 7, 73))(x)
    #outputs = Yolo_Reshape((7, 7,73))(x)
