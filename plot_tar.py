...
import os
path='/home/user01/data_ssd/Abbas/OBJECT_DETECTION_YOLO/synthetic_Fruit/target/'
...
def gt_main(prediction,image,img_num): #prediction=(1,7,7,11) and image= 416,416,3
